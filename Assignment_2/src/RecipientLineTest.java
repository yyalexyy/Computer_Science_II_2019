...
public class RecipientLineTest {
	...
	public void testAddNewRecepient() {
		...
		try {
			assertTrue(aRecipientLine.addNewRecepient(r1));
			assertTrue(aRecipientLine.addNewRecepient(r2));
			assertTrue(aRecipientLine.addNewRecepient(r3));
			assertTrue(aRecipientLine.addNewRecepient(r4));
			assertTrue(aRecipientLine.addNewRecepient(r5));
		...
		try {
			assertFalse(aRecipientLine.addNewRecepient(r6));
	...
	public void tesRecipientTurn() {
		...
		try {
			try {
				aRecipientLine.addNewRecepient(r1);
				aRecipientLine.addNewRecepient(r2);
			} catch (RecipientException e) {
				// TODO Auto-generated catch block
				assertTrue("This should not have thrown an exception", false);
			}
	...
	public void testToArrayRecipient() {
		...
		try {
			aRecipientLine.addNewRecepient(r2);
			aRecipientLine.addNewRecepient(r3);
			aRecipientLine.addNewRecepient(r4);
			aRecipientLine.addNewRecepient(r5);
		} catch (RecipientException e1) {
			// TODO Auto-generated catch block
			assertTrue("This should not have thrown an exception", false);
		}
